      ...
      <div className="container px-6">
        ...
        >
          ...
          <p className="text-muted-foreground mb-10">
            I'm always open to new opportunities in infrastructure, networking, IT operations, and automation testing, where I can contribute and continue to grow my skills.
          </p>
