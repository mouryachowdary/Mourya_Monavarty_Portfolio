...
export const experiences = [
  {
    ...
    tasks: [
      ...
      "Administering Microsoft Teams including user management, channel governance, meeting policies, and Teams Phone configurations",
      "Managing Exchange Online administration covering mailbox provisioning, mail flow rules, retention policies, and troubleshooting",
      "Overseeing Microsoft Intune administration for device enrollment, compliance policies, app deployment, and conditional access",
      "Administering SharePoint Online including site provisioning, permissions management, content governance, and collaboration workflows",
      "Managing Microsoft Defender administration for endpoint protection, threat detection, security policies, and incident response",
      "Resolving P1 to P4 incidents and service requests with SLA adherence, ensuring minimal business impact across all priority levels",
    ],
    tags: [
  ...
  },
  {
    ...
    tasks: [
      ...
      "Administered Active Directory (users, GPOs, OUs) and managed VMware ESXi/vSphere virtualized environments",
      "Configured and maintained DNS, DHCP, and File Server roles on Windows Server infrastructure",
      "Resolved 200+ incidents and managed change requests using ServiceNow, adhering to ITIL best practices",
      "Automated routine maintenance tasks using PowerShell scripts, reducing manual effort by 40%",
      "Monitored server health and uptime using SCOM dashboards, achieving 99.5% availability SLA",
      "Managed Azure AD synchronization and hybrid identity configurations for seamless cloud integration",
    ],
    tags: [
      "Windows Server",
      "VMware vSphere",
  ...
  },
  {
    ...
    tasks: [
      "Configured and maintained Cisco switches, routers, wireless APs, and Sophos XG Firewall for a 200+ user network",
      "Tracked and managed 200+ IT assets using Snipe-IT, ensuring accurate inventory records for audit readiness",
      "Executed Install, Move, Add, and Change (IMAC) activities for desktops and laptops across the organization",
      "Installed, configured, and maintained Windows, Linux, and macOS operating systems",
      "Provided Tier-2 and Tier-3 technical support, resolving escalated issues with 95% first-call resolution",
      "Monitored LAN/WAN performance and bandwidth utilization, proactively resolving issues to minimize downtime",
      "Documented network topology diagrams and maintained standardized asset inventory for compliance readiness",
    ],
    tags: [
      "TCP/IP",
      "DNS",
